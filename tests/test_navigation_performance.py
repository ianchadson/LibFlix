...
class DownloadShellTests(unittest.TestCase):
    ...
    def test_download_actions_launch_books_shortcut_before_kindle(self):
        ...
        self.assertIn("Get shortcut", downloads)
        self.assertIn("Set up  Books", downloads)
        self.assertIn("Already set up", downloads)
        self.assertNotIn("One-time setup", downloads)
        self.assertNotIn("data-apple-books-selected", downloads)
